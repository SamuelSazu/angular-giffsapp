// To parse this data:
//
//   import { Convert, SearchGifsReponse } from "./file";
//
//   const searchGifsReponse = Convert.toSearchGifsReponse(json);
//
...
export enum SourceTLD {
    Empty = "",
    LivenationUk = "livenation.uk",
}

export enum Title {
    GIFBySlipknot = "GIF by Slipknot",
    SlipknotGIFByKNOTFEST = "Slipknot GIF by KNOTFEST",
    SlipknotGIFByLiveNationUK = "Slipknot GIF by Live Nation UK",
}
...
export enum DisplayName {
    Knotfest = "KNOTFEST",
    LiveNationUK = "Live Nation UK",
    Slipknot = "Slipknot",
}

export enum Username {
    Knotfest = "knotfest",
    Livenationuk = "livenationuk",
    Slipknot = "slipknot",
}
...
export class Convert {
    public static toSearchGifsReponse(json: string): SearchGifsReponse {
        return cast(JSON.parse(json), r("SearchGifsReponse"));
    }

    public static searchGifsReponseToJson(value: SearchGifsReponse): string {
        return JSON.stringify(uncast(value, r("SearchGifsReponse")), null, 2);
    }
}
...
const typeMap: any = {
    ...
    "Title": [
        "GIF by Slipknot",
        "Slipknot GIF by KNOTFEST",
        "Slipknot GIF by Live Nation UK",
    ],
    "TrendingDatetime": [
        "0000-00-00 00:00:00",
    ],
